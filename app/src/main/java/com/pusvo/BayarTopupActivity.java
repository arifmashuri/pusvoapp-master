...
public class BayarTopupActivity extends AppCompatActivity {
...
//    }
    ...
    @OnClick(R.id.buttonBayar) void login() {
        ...
        Call<Data> call = api.konfirmasitopup("Bearer "+sharedPrefManager.getSPBearer(),kode_transaksi,editTextKode_voucher.getText().toString(),editTextKode_voucher2.getText().toString(),randomUUIDString,SHA1,api_key,api_secret);
                ...
                if (response.body() != null && response.body().getStatus() != null) {
                    ...
                    if (status.equals(1)) {
                        if (data.getStatus() == 0) {
                            ...
                            String hargashow = Enkripsi.tentukanhargatopuprupiah(harga3, metode,data.getRand());
                            Double harga = Enkripsi.tentukanhargatopup(harga3, metode,data.getRand());
                            ...
                            if (metode == 15) {
                                ...
                                instruksi2.setVisibility(View.VISIBLE);
                                petunjukbayar.setText("Petunjuk pembayaran melaui website Binance :\n\n" +
                                        ...
                                        "Petunjuk pembayaran melaui aplikasi Binance :\n\n" +
                            ...
                            if (metode == 17) {
                                ...
                                petunjukbayar.setText("Petunjuk pembayaran melaui website Tokocrypto :\n\n" +
                            ...
                            if (metode == 13) {
                                ...
                                harga1 = harga.toString();
                                instruksi2.setVisibility(View.VISIBLE);
                                petunjukbayar.setText("Petunjuk pembayaran melaui website Indodax :\n\n" +
                                        ...
                                        "10. Jika status menunjukan pembayaran belum diterima tetapi Anda sudah merasa membayar, silakan hubungi kami.\n\n\n" +
                                        "Petunjuk pembayaran melaui aplikasi Indodax :\n\n" +
                            ...
                            Toast.makeText(context, "Status pesanan sudah berubah, silakan cek riwayat transaksi", Toast.LENGTH_SHORT).show();
                        }
                    }
                    else {
