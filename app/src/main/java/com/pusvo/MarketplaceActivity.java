...
public class MarketplaceActivity extends AppCompatActivity {
    ...
    @OnClick(R.id.buttonPaste) void losgin() {
        ...
        ClipData.Item item = clipData.getItemAt(0);
            ...
            if (item.getText().toString().length() > 10 && !item.getText().toString().isEmpty() && text.matches("[0-9]+")) {
                    // Set the text to target textview.
                    editTextMeter.setText(text);
                } else {
                    Toast.makeText(context, "Periksa format Nomor VA", Toast.LENGTH_SHORT).show();
...
//        String produk = editTexthp.getText().toString();
            ...
            Toast.makeText(context, "Nomor HP/ID Pelanggan tidak lengkap", Toast.LENGTH_SHORT).show();
        }
    }
    @Override
...
//                Toast.makeText(getApplicationContext(),nama,Toast.LENGTH_SHORT).show();
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        getSupportActionBar().setTitle("Bayar Tagihan Marketplace");
        ...
        sk.setText(R.string.skmarketplace);
  ...
  //      Spinner spinner = (Spinner) findViewById(R.id.spinner2);
        ...
        produkClickListener =new ProdukClickListener() {
            ...
            public void onClick(Integer id,Double harga,String deskripsi) {
                ...
                metodeAdapter = new MetodeAdapter(context,itemClickListener, listmetode,null,sharedPrefManager.getSPMetodeBaru());
        ...
        Retrofit retrofit = new Retrofit.Builder()
                ...
                .build();
        API api = retrofit.create(API.class);
        Call<Data> call = api.dataproduk(12);
        call.enqueue(new Callback<Data>() {
            @Override
            public void onResponse(@NonNull Call<Data> call, @NonNull retrofit2.Response<Data> response) {
                ...
                if(response.body()!=null && response.body().getData()!=null) {
                    ...
                    produkAdapter = new ProdukAdapter(context, produkClickListener, listproduk, 0, idproduk);
    ...
    public void model1(String hp, String meter) {
        if (hp.length() > 4 || meter.length() > 4) {
            ...
            boolean meterbenar = Enkripsi.validator(9,18,"nomor",meter);
